...
### Features
- **File Uploads**: Upload files up to 1GB each, with no limit on the number of files. (Around 1TB of storage on my storagebox available)
- **Link Shortening**: Supports long URLs. If you encounter any issues, feel free to reach out to me on Discord (jesn.zip), and I'll address them promptly.
- **File Converting**: Supports up to 1GB of every common files you want to convert. Converting on my server with ffmpeg.
...
### Contact
If you have any questions or need assistance, please reach out to me on Discord (jesn.zip) or via email (jason@jesn.zip).
